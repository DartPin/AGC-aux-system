...
import axios from 'axios';
    ...
    mounted(){
        axios.get('http://localhost:8000/Maitanence/workList')
        .then(response => (
    ...
    methods: {
        sendPeriod(){
            let that = this
            axios.post("http://localhost:8000/Maitanence/workListPeriod", this.period)
        ...
        sendPeriodReport(){
            let that = this
            axios.post("http://localhost:8000/Maitanence/workListPeriodReport", this.period)
            .then(function (response) {
                that.workList = response.data;
            })
        },
        pushNewTask() {
            ...
            let that = this
            axios.post("http://localhost:8000/Maitanence/workList", this.workItem)
            .then(function (response) {
                that.workList = response.data;
            })
            this.workItem = {
